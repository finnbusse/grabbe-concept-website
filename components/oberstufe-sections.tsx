...
const quickLinkIcons: Record<string, ReactNode> = {
  ...
  Klausurplaene: <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M8 2v4"/><path d="M16 2v4"/><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M3 10h18"/></svg>,
...
export function OberstufeSections({ content, quicklinks }: OberstufeSectionsProps) {
  return (
    <>
        ...
        <div className="mx-auto max-w-6xl px-4 lg:px-8">
          ...
          <div className="mt-20 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              {
                title: "Abschluesse",
                text: content.overview_abschluesse as string,
              },
            ].map((item, i) => (
      ...
      {/* ═══ Antraege Section (white bg, 2-col like NachmittagSection) ═══ */}
