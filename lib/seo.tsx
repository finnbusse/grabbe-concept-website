...
export async function getSEOSettings(): Promise<SEOSettings> {
  ...
  return {
    ...
    orgEmail: s.seo_org_email || s.school_email || s.contact_email || "",
    orgPhone: s.seo_org_phone || s.school_phone || s.contact_phone || "",
    orgStreet: s.seo_org_address_street || s.school_address || "",
    orgCity: s.seo_org_address_city || s.school_city || "Detmold",
