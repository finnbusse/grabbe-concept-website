...
export function emailChangeConfirmationTemplate(options: EmailChangeOptions): { subject: string; html: string } {
  const content = `
    ...
    <p style="margin:0 0 18px;font-family:'Geist','Segoe UI',Arial,sans-serif;font-size:15px;line-height:1.7;color:#364152;">
      ...
      Ihre neue E-Mail-Adresse soll <strong>${options.newEmail}</strong> werden.
    </p>
    <p style="margin:0 0 18px;font-family:'Geist','Segoe UI',Arial,sans-serif;font-size:15px;line-height:1.7;color:#364152;">
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin:0 0 16px;">
      <tr>
        <td align="center">
          <a href="${options.confirmUrl}" style="display:inline-block;background-color:#2563b0;color:#f5f7fa;text-decoration:none;font-family:'Geist','Segoe UI',Arial,sans-serif;font-size:15px;font-weight:600;padding:12px 24px;border-radius:8px;">
    ...
    <p style="margin:0;font-family:'Geist','Segoe UI',Arial,sans-serif;font-size:12px;line-height:1.6;color:#667085;">
      ...
      <a href="${options.confirmUrl}" style="color:#2563b0;word-break:break-all;">${options.confirmUrl}</a>
    </p>
  `
